...
var inFile = './anticholinergics.json';
var outFile = './anticholinergic-generics-dropdown.json';
var outArray = [];
var anticholinergics = [136, 153, 173, 198];
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, cross_fetch_1.fetch("https://rxnav.nlm.nih.gov/REST/rxcui.json?name=" + name_1)
                                                    ...
                                                    .then(function (res) {
                                                    for (var _i = 0, anticholinergics_1 = anticholinergics; _i < anticholinergics_1.length; _i++) {
                                                        var id = anticholinergics_1[_i];
                                                        outArray.push({
                                                            name: name_1,
