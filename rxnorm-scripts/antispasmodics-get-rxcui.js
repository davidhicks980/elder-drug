...
var inFile = './json-out/antispasmodics.json';
var outFile = './json-out/antispasmodics-generics-dropdown.json';
var outArray = [];
var antispasmodics = [199];
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, cross_fetch_1.fetch("https://rxnav.nlm.nih.gov/REST/rxcui.json?name=" + name_1)
                                                    ...
                                                    .then(function (res) {
                                                    for (var _i = 0, antispasmodics_1 = antispasmodics; _i < antispasmodics_1.length; _i++) {
                                                        var id = antispasmodics_1[_i];
                                                        outArray.push({
                                                            name: name_1,
