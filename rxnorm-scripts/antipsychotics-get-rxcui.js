...
var inFile = './json-out/antipsychotics.json';
var outFile = './json-out/antipsychotics-generics-dropdown.json';
var outArray = [];
var antipsychotics = [137, 155, 157, 169, 179, 200, 52];
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, cross_fetch_1.fetch("https://rxnav.nlm.nih.gov/REST/rxcui.json?name=" + name_1)
                                                    ...
                                                    .then(function (res) {
                                                    for (var _i = 0, antipsychotics_1 = antipsychotics; _i < antipsychotics_1.length; _i++) {
                                                        var id = antipsychotics_1[_i];
                                                        outArray.push({
                                                            name: name_1,
