...
function () {
  function EnterDrugFormComponent(state, fire, fb, dialog) {
    ...
    this.drugsGroup = this.fb.group({
      drugs: this.fb.array([new forms_1.FormControl("", [forms_1.Validators.pattern("[a-zA-Z0-9 -]*"), forms_1.Validators.minLength(2), forms_1.Validators.maxLength(70)])])
    });
    this.activeInput = 0;
    ...
    this.drugs.valueChanges.pipe(operators_1.debounce(function () {
      return rxjs_1.interval(50);
  ...
  EnterDrugFormComponent.prototype.search = function () {
    ...
    this.drugs.value.filter(function (drug) {
      _this.fire.entryMap.has(drug.toLowerCase()) ? out.push(drug) : _this.drugs.controls[index].setErrors({
        notDrug: true
      });
      index++;
    });
  ...
  EnterDrugFormComponent.prototype.addInput = function () {
    if (this.drugs.length < 8) {
      this.drugs.push(this.fb.control("", [forms_1.Validators.pattern("[a-zA-Z0-9 -]*"), forms_1.Validators.minLength(2), forms_1.Validators.maxLength(70)]));
    }
  };
  ...
  __decorate([core_1.ViewChildren(autocomplete_1.MatAutocompleteTrigger)], EnterDrugFormComponent.prototype, "trigger");

  __decorate([core_1.ViewChildren(input_1.MatInput)], EnterDrugFormComponent.prototype, "submission");

  __decorate([core_1.ViewChild("drawer")], EnterDrugFormComponent.prototype, "sidenav");

  EnterDrugFormComponent = __decorate([core_1.Component({
...
var EmptyInputComponent =
/** @class */
function () {
  function EmptyInputComponent() {}

  EmptyInputComponent = __decorate([core_1.Component({
